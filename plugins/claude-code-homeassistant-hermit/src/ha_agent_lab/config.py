...
class AppConfig:
    ...
    def primary_url(self) -> str | None:
        """Single resolved URL. Uses ha_url unless dual-URL mode is active."""
        return self.ha_url or self.ha_local_url or self.ha_remote_url
