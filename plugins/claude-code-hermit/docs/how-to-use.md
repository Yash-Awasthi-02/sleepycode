...
[Claude Code](https://code.claude.com) v2.1.110+ and a paid Claude plan (Pro or Max). Node.js 22+ for hooks. Optional: **tmux** for always-on mode, **Bun** for phone channels (Discord, Telegram).
